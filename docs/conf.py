...
#configure(globals())
configure(globals(), 'lino_ciao.projects.ciao1.settings.demo')
...
project = "Lino Ciao"
copyright = lino_ciao.SETUP_INFO['author']
...
release = lino_ciao.SETUP_INFO['version']
